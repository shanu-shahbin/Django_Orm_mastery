...
def students(request):
    ...
    roll_no=6,
    name="John Doe",
    year_in_school='jr',  # Assuming 'jr' is the value for Junior
    photo=None  # If you don’t want to add a photo, otherwise provide the file path
)
            # Query examples
            ...
            for stds in select_all:
                print(f"{stds} - list of all: {stds.name}")
